...
#     No of stages
#     Block size
#     Num of sboxes per stage
#     Permutation (it's ok if you use standard permutation)

num_stages = raw_input("No of stages: ")
bloc_size = raw_input("Block Size: ")
num_sboxes =raw_input("Num of sboxes per stage")

num_sboxes_stage = bloc_size/num_sboxes

# Output:

#     Path showing high bias
#     Sample output
#     Readme file to help us interpret your output
